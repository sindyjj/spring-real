...
import com.spring.myweb.freeboard.comtroller.FreeBoardController;
...
public class FreeBoardControllerTest {
    ...
    */
	...
	@Autowired
	private WebApplicationContext ctx; // 컨테이너에 등록된 모든 빈을 사용할 떄.
	
//	@Autowired
//	private FreeBoardController controller; // 컨트롤러 하나만 테스트 하겠다.
	
	//MockMvc는 웹 어플리케이션을 서버에 배포하지 않아도 스프링 MVC 동작을
	//구현할 수 있는 가상의 구조를 만들어 줍니다.
	private MockMvc mockMvc;
	
	@BeforeEach // 테스트 시작 시 다른메서드 실행 전에 항상 먼저 구동되는 기능을 선언.
	public void setup() {
		//가상 구조를 세팅
...
//		this.mockMvc = MockMvcBuilders.standaloneSetup(controller).build();
	...
	void testContect() throws Exception {
