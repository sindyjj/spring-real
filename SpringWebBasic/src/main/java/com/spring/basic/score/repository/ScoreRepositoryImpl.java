...
//@Component ->3개층 이
@Repository // 빈등록 -> Service가 의존하는 객체니까
public class ScoreRepositoryImpl implements IScoreRepository {
	...
	static {
		...
		Score stu1 = new Score(new ScoreRequestDTO("유훈모",100,100,100));
		Score stu2 = new Score(new ScoreRequestDTO("성삼경",1,1,1));
		Score stu3 = new Score(new ScoreRequestDTO("원정욱",99,99,99));
